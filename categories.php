...
<meta charset="UTF-8" />
    ...
    <title>TREZ Blogsite | Categories</title>
    <!-- css external links -->
...
<body  class="bg">
  ...
  <div class="containerr" style="margin-top: 3rem;">

    
    <div class="row mx-auto mb-5 anim-to-top" style="margin-top: 1.5rem; max-width: 1400px; width:90%;">

      <div class="col-12 display-6 d-flex justify-center align-center py-4 fw-bold mx-auto text-center" style="background: #edf6f5; margin-top: -5rem; color: #4d4d4d; border-radius: 20px;">Category</div>
