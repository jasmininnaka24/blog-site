...
<head>
  ...
  <title>TREZ Blogsite | Validation</title>
...
<div class="container">
    ...
    <h3 class="error bg-danger text-white p-3 text-center rounded-3 hidden" style="transition: all .5s ease-in;">Invalid Username of Password</h3>
      <h1 class="text-center my-3" style="color: #555;">Fill out to edit</h1>
      ...
      <div class="mt-4 d-flex align-items-center justify-content-center">
        <button name="validate" class="btn text-light text-center" style="background: #555; width: 10rem; font-weight: 600;">Proceed</button>
      </div>
      </form>
      <?php  } ?>
